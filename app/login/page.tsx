...
const features = [
  ...
  {
    icon: MessageSquare,
    label: "Mensajes y cotizaciones",
    desc: "Responde a tus clientes",
  },
    ...
    <div className="min-h-screen flex overflow-hidden">
      ...
      <div className="hidden lg:flex lg:w-[55%] relative flex-col justify-between overflow-hidden">
        ...
        <div className="relative z-10 px-12 pb-14 space-y-10">
          ...
          >
            <p className="text-indigo-300 text-sm font-semibold uppercase tracking-widest mb-4 drop-shadow-lg">
            ...
            <p className="text-white/80 text-base leading-relaxed max-w-sm drop-shadow-lg [text-shadow:0_1px_8px_rgba(0,0,0,0.9)]">
              Gestiona proyectos, servicios, cotizaciones y mensajes desde un
              solo dashboard en tiempo real.
            </p>
          </motion.div>
      ...
      ══════════════════════════════════════ */}
      <div className="flex-1 flex items-center justify-center p-4 sm:p-6 bg-slate-50 dark:bg-slate-950 relative overflow-hidden transition-colors duration-500">
        {/* Blobs decorativos */}
        <div className="absolute top-0 right-0 w-[450px] h-[450px] bg-indigo-500/10 dark:bg-indigo-500/5 rounded-full blur-[120px] translate-x-1/3 -translate-y-1/3 pointer-events-none" />
        <div className="absolute bottom-0 left-0 w-[400px] h-[400px] bg-violet-500/10 dark:bg-violet-500/5 rounded-full blur-[100px] -translate-x-1/3 translate-y-1/3 pointer-events-none" />
        ...
        >
          ...
          >
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-indigo-50/50 dark:bg-indigo-500/10 border border-indigo-100 dark:border-indigo-500/20 text-indigo-600 dark:text-indigo-400 text-[10px] sm:text-xs font-semibold mb-4 sm:mb-5">
              <Shield className="h-3 sm:h-3.5 w-3 sm:w-3.5" />
              Acceso restringido
            </div>
            <h1 className="text-2xl sm:text-3xl font-bold font-heading text-slate-900 dark:text-slate-50 mb-2 leading-tight">
              Bienvenido de
              <br />
              <span className="text-indigo-600 dark:text-indigo-400">vuelta</span>
            </h1>
          ...
          <motion.div
            ...
            className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200/80 dark:border-slate-800 shadow-2xl shadow-slate-200/50 dark:shadow-none p-6 sm:p-8"
          >
                ...
                >
                  ...
                  <div className="space-y-1.5">
                    ...
                    <Input
                      ...
                      autoComplete="email"
                      disabled={isLoading}
                      className="h-11 bg-slate-50 border-slate-300 focus:border-indigo-500 transition-all duration-200 focus:shadow-md focus:shadow-indigo-100/50"
                    />
                    <AnimatePresence>
                      {errors.email && (
                        <motion.p
                  ...
                  <div className="space-y-1.5">
                    ...
                    <div className="relative">
                      <Input
                        ...
                        disabled={isLoading}
                        className="h-11 pr-11 bg-slate-50 border-slate-300 focus:border-indigo-500 transition-all duration-200 focus:shadow-md focus:shadow-indigo-100/50"
                      />
                      <button
                        type="button"
