...
export function Contact() {
  return (
    <section id="contacto" className="py-16 md:py-24 lg:py-32 relative overflow-hidden">
      ...
      <div className="container relative z-10 max-w-5xl mx-auto px-4">
        ...
        <div className="grid lg:grid-cols-2 gap-6 md:gap-8 lg:gap-10 items-center">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="rounded-3xl border border-border/50 bg-card/60 backdrop-blur-sm p-6 md:p-8 lg:p-10 text-center"
          >
            {/* Icono WhatsApp animado */}
            <motion.div
              animate={{ scale: [1, 1.08, 1] }}
              transition={{ duration: 2.5, repeat: Infinity, ease: 'easeInOut' }}
              className="inline-flex items-center justify-center w-16 h-16 md:w-20 md:h-20 lg:w-24 lg:h-24 rounded-full bg-[#25D366]/10 border-2 border-[#25D366]/20 mb-6 md:mb-8 mx-auto"
            >
              <svg className="w-8 h-8 md:w-10 md:h-10 lg:w-12 lg:h-12 text-[#25D366]" fill="currentColor" viewBox="0 0 24 24">
